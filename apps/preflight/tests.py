...
class PreflightTests(TestCase):
    ...
    def test_decision_note_is_saved_in_workfile_record(self):
        ...
        self.assertContains(response, "Saved to workfile")
        self.assertContains(response, "Deferred")
        self.assertContains(response, "Verify the source commentary before delivery.")
        self.assertNotContains(response, "note saved")
        self.assertNotContains(response, "This records how you handled the item")
