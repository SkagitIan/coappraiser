...
Scenario: 03_incomplete
Identifier: SYNTHETIC-SUBJECT-001
Purpose: The same-subject rendered report and photos are present, but the structured XML export is missing.
XML status: intentionally missing
