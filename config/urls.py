...
from apps.marketing.views import home, legacy_page
...
urlpatterns = [
    ...
    path("solutions/uad-36-compliance-copilot/", legacy_page, {"page": "solutions/uad-36-compliance-copilot"}),
    path("solutions/revision-response-agent/", legacy_page, {"page": "solutions/revision-response-agent"}),
    path("solutions/market-evidence-pack/", legacy_page, {"page": "solutions/market-evidence-pack"}),
    path("solutions/workfile-guardian/", legacy_page, {"page": "solutions/workfile-guardian"}),
